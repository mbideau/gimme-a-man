...
# program
MAIN_SCRIPT        := $(srcdir)/gimme_a_man.sh
...
DIRS                = $(LOCALE_DIR) $(LOCALE_DIRS) $(MAN_DIR)
...
# man helper (to produce man pages from --help)
# YES : its producing its own man page from itself (eats its own dog food)
GIMME_A_MAN        := $(MAIN_SCRIPT)
